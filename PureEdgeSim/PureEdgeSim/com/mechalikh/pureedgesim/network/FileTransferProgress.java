...
import PaperScenario.OrchOptRequest;

public class FileTransferProgress {
	public static enum Type {
		TASK, CONTAINER, RESULTS_TO_DEV, RESULTS_TO_ORCH, REQUEST, OPTIMIZATION_REQUEST_SENT,
		OPTIMIZATION_REQUEST_RESPONSE_SENT, OPTIMIZATION_REQUEST_CONFIRMED_SENT, OPTIMIZATION_REQUEST_NOT_CONFIRMED_SENT 
	}

	private Task task;
	private OrchOptRequest Request;
	...
	public OrchOptRequest getRequest() {
		return Request;
	}

	public void setRequest(OrchOptRequest request) {
		Request = request;
	}
