...
public abstract class DataCenter extends DatacenterSimple {
	...
	//private static Random randRange = new Random();
	private int range; 												 
	...
	public DataCenter(SimulationManager simulationManager, List<? extends Host> hostList, List<? extends Vm> vmList) {
		...
		Random randRange = simulationManager.getRandomGenerator();
		range = SimulationParameters.EDGE_DATACENTERS_RANGE_MIN + randRange.nextInt(SimulationParameters.EDGE_DATACENTERS_RANGE_MAX - SimulationParameters.EDGE_DATACENTERS_RANGE_MIN + 1);
	}
