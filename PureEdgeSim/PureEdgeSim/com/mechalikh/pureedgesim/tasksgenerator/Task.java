...
public class Task extends CloudletSimple {
	...
	private ArrayList<PaperEdgeDevice> UsersDevices;
	...
	public Task(int id, long cloudletLength, long pesNumber) {
		...
		UsersDevices = new ArrayList<PaperEdgeDevice>();	  
	}

	public ArrayList<PaperEdgeDevice> getUsersDevices() {
		return UsersDevices;
	}

	public void addUserDevices(PaperEdgeDevice userDevice) {
