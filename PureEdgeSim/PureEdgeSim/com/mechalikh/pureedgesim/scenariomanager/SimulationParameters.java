...
public class SimulationParameters { 
	...
	public static String DEVICES_DISTRIBUTION = ""; // Distribution of users over Edge and Apps
	public static long SEED;					    // A seed to allow repeatable experiments
	...
	public static int EDGE_DATACENTERS_RANGE_MIN;     // The range of edge servers (in meters) at minimum extension
	public static int EDGE_DATACENTERS_RANGE_MAX;     // The range of edge servers (in meters) at maximum extension
