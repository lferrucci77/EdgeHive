...
public class SimulationVisualizer {
	...
	private PaperTotalResourcesChart PTResourcesChart;
	private PaperNumTasks PNumTasks;												   
	public SimulationVisualizer(SimulationManager simulationManager) {
		...
		PTResourcesChart = new PaperTotalResourcesChart("Resources utilization", "Iteration", "Percentage (%)", simulationManager);
		PNumTasks =  new PaperNumTasks("Total number of Tasks", "Iteration", "Number of Tasks", simulationManager);
		...
		charts.add(PTResourcesChart);
		charts.add(PNumTasks);					
	}
	...
	public void saveCharts() throws IOException {
		...
		BitmapEncoder.saveBitmapWithDPI(PTResourcesChart.getChart(), folderName + "/resources_usage",
				BitmapFormat.PNG, 300);
		
		 
		BitmapEncoder.saveBitmapWithDPI(PNumTasks.getChart(), folderName + "/total_num_tasks",
				BitmapFormat.PNG, 300);
