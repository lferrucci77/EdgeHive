...
public class PaperSettings {
	...
	public static double LATENCY_DELAY = 0.00006; // latency delay for "point" of distance, in seconds
	public static double MIN_LATENCY_DELAY = 0.02; // minimum latency for the channel, in seconds
	public static double LINK_LATENCY = 0.01;       // latency delay of a network link 
}
