...
public class DatasetToEdgeDatacenter {
	...
	static int cores = 975;
	static int ram = 24000;
	...
	public static void main(String[] args) {
		try {
			CSVReader reader = new CSVReader(new FileReader("C:\\Users\\Ferrucci\\eclipse-workspace\\PureEdgeSimJournal.zip_expanded\\PureEdgeSim\\AustDatasetMelbourbeOptus.csv"));
			...
			File file = new File("C:\\Users\\Ferrucci\\eclipse-workspace\\PureEdgeSimJournal.zip_expanded\\PureEdgeSim\\PureEdgeSim\\PaperScenario_Settings\\edge_datacenters_new.xml");
