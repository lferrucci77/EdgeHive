...
public class PaperLog {
	...
	public static String getFileName(String Name, String extension) {
		...
		String outputFilesName = Simulation.getOutputFolder() + "Paper-Devices-" + SimulationParameters.MAX_NUM_OF_EDGE_DEVICES + "-Applications-" + SimulationParameters.APPLICATIONS_LIST.size();
